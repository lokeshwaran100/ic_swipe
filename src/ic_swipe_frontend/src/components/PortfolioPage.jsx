...
import { Menu, Home, RefreshCw, Wallet } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="hidden md:flex gap-4 items-center">
            <button
              ...
              disabled={refreshing}
              className="flex items-center gap-2 text-gray-300 hover:text-white transition disabled:opacity-50"
            >
          ...
          >
            <div className="flex flex-col p-4 gap-4">
              <button
                onClick={() => fetchPortfolioData(false)}
                disabled={refreshing}
                className="flex items-center gap-2 text-gray-300 hover:text-white transition text-left disabled:opacity-50"
              >
                <RefreshCw className={`w-4 h-4 ${refreshing ? 'animate-spin' : ''}`} />
                {refreshing ? 'Refreshing...' : 'Refresh'}
              </button>
